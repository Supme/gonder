...
CREATE TABLE IF NOT EXISTS `auth_unit_right` (
  `id` integer NOT NULL PRIMARY KEY AUTOINCREMENT,
  `auth_unit_id` integer(11) NOT NULL,
  `auth_right_id` integer(11) NOT NULL
);
...
CREATE TABLE IF NOT EXISTS `auth_user_group` (
  `id` integer NOT NULL PRIMARY KEY AUTOINCREMENT,
  `auth_user_id` integer(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `campaign` (
  `id` integer NOT NULL PRIMARY KEY AUTOINCREMENT,
  `group_id` integer(11) NOT NULL,
  `profile_id` integer(11) DEFAULT '0',
  `sender_id` integer(11) DEFAULT '0',
  `name` text NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `profile` (
  ...
  `stream` integer(11) NOT NULL DEFAULT '0',
  `resend_delay` integer(11) NOT NULL DEFAULT '0',
  `resend_count` integer(11) NOT NULL DEFAULT '0'
);
...
(21, 'SORRY, THIS MESSAGE COULD NOT BE RECEIVED.', 2),
...
(112, 'ALLOWED TO BE RELAYED THRU THIS MTA', 2),
...
(147, 'MATCH WITH YOUR IP ADDRESS', 2),
