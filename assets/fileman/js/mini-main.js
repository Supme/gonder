...
RoxyUtils.GetFileIcon = function(path){
  ret = '/assets/fileman/images/filetypes/unknown.png';//'images/filetypes/file_extension_' + RoxyUtils.GetFileExt(path).toLowerCase() + '.png';
  if(fileTypeIcons[RoxyUtils.GetFileExt(path).toLowerCase()]){
    ret = '/assets/fileman/images/filetypes/' + fileTypeIcons[RoxyUtils.GetFileExt(path).toLowerCase()];
  }
...
function Directory(fullPath, numDirs, numFiles){
  ...
  this.GetHtml = function(){
     ...
     html += '<div><img src="/assets/fileman/images/'+(this.dirs > 0?'dir-plus.png':'blank.gif')+'" class="dirPlus" width="9" height="9">';
     html += '<img src="/assets/fileman/images/folder.png" class="dir"><span class="name">'+this.name+' ('+this.files+')</span></div>';
     html += '</li>';
  ...
  this.Select = function(selectedFile){
    ...
    el.children('img.dir').prop('src', '/assets/fileman/images/folder.png');
    this.SetStatusBar();
  ...
  this.SetOpened = function(){
    ...
    if(li.find('li').length < 1)
      li.children('div').children('.dirPlus').prop('src', '/assets/fileman/images/blank.gif');
    else if(this.IsExpanded())
      li.children('div').children('.dirPlus').prop('src', '/assets/fileman/images/dir-minus.png');
    else
      li.children('div').children('.dirPlus').prop('src', '/assets/fileman/images/dir-plus.png');
  };
...
function dragFileOver(){
  $(this).children('img.dir').attr('src', '/assets/fileman/images/folder-green.png');
}
function dragFileOut(){
  $('#pnlDirList').find('img.dir').attr('src', '/assets/fileman/images/folder.png');
}
...
function makeDragDir(e){
  ...
  return '<div class="pnlDragDir" data-path="'+f.fullPath+'"><img src="/assets/fileman/images/folder.png" align="absmiddle">&nbsp;'+f.name+'</div>';
}
...
function switchView(t){
  ...
  if(t == 'thumb'){
    $('#pnlFileList .icon').attr('src', '/assets/fileman/images/blank.gif');
